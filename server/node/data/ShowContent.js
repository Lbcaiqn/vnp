...
const content = {
  population:{
    ...
    scratter:{
      title: '散点图',
      content:[
        {text:'以散点图为例，展示最基本的使用，选择要画的图及X轴和Y轴数据。',img:[purl+'scatter/00.png']},
        {text: '不需要其他设置，就能画出散点图',img:[purl+'scatter/01.png']}
      ]
    },
    plot:{
      title: '折线图',
      content:[
        {
          text:'折线图最多可支持同时绘制5条折线，这里我们选择绘制1949年-2019年的出生率，死亡率和自然增长率的变化趋势折线图。',
    ...
    bar:{
      ...
      content: [
        {
          text: '柱状图支持绘制绘制3种数据，绘制1999年-2019年总人口变化柱状图',
          img: [purl+'bar/20.png']
        },
        {
        ...
        {
          text: '绘制1999年-2019年城镇人口与农村人口在总人口的占比。由于源数据中没有城镇人口占比和农村人口占比这两个数据。所以需要通过自定义列，用有的数据计算出新的数据。c4代表第四列，c5代表第五烈，c1代表第一列，c4/c1*100则是城镇人口除总人口再乘100转成百分制。',
          img: [purl+'bar/27.png',purl+'bar/28.png',purl+'bar/29.png']
        },
        {
          text: '也可以画叠加柱状图，这里我们使用图例。',
